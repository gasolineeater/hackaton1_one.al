  ...
  return (
    <Box>
      ...
      <Box sx={{
        ...
        {/* AI Insights Section */}
        <Box id="ai-insights" sx={{ width: '100%' }}>
          <Box sx={{
            width: '100%',
            bgcolor: '#6A1B9A',
            py: 2,
        ...
        <Box id="personalized-recommendations" sx={{ width: '100%' }}>
          <Box sx={{
            width: '100%',
            bgcolor: '#6A1B9A',
            py: 2,
          ...
          {/* Recommendation Tabs */}
          <Box sx={{ width: '100%', mb: 3, bgcolor: 'white', borderRadius: 0.4, p: 1 }}>
            <Tabs
              value={selectedTab}
        ...
        <Box id="ai-methodology" sx={{ width: '100%' }}>
          <Box sx={{
            width: '100%',
            bgcolor: '#6A1B9A',
            py: 2,
